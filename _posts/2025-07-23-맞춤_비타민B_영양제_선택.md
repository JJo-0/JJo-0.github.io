...
## 핵심 요약
- 비타민 B군은 피로 유형과 생활 패턴에 맞춰 용량과 조합을 선택해야 체감 차이가 큽니다.
- 이 글은 목적 기반 추천 로직과 성분 비교표를 함께 제공해 선택 시간을 줄입니다.
- 인터랙티브 탭으로 고함량 B군과 종합비타민의 차이를 바로 비교할 수 있습니다.

## 빠른 탐색
1. <a href="#tab-nav" onclick="document.querySelector('[data-tab=recommender]').click()">내 증상 기반 추천 경로</a>
2. <a href="#tab-nav" onclick="document.querySelector('[data-tab=comparison]').click()">B군 vs 종합비타민 핵심 비교</a>
3. <a href="#tab-nav" onclick="document.querySelector('[data-tab=guide]').click()">구매 기준 4가지와 복용 체크리스트</a>
                    ...
                    <table class="w-full min-w-[700px] text-sm text-left text-stone-600">
                        ...
                        <tbody>
                            ...
                            <tr class="bg-white">
                                ...
                                <td class="px-6 py-4 bg-amber-50 rounded-br-lg"><a href="https://kr.iherb.com/pr/life-extension-two-per-day-multivitamin-120-tablets/137715" target="_blank" rel="noopener noreferrer" class="text-amber-700 hover:text-amber-900 underline">쿠팡/아이허브 등 해외직구</a></td>
                            </tr>
                            <tr class="bg-white border-t">
                                <td colspan="3" class="px-6 py-2 text-xs text-gray-400 text-center">※ 직접 구매·사용한 제품입니다. 광고·협찬·제휴 마케팅이 아닙니다.</td>
                            </tr>
                        </tbody>
                    </table>
                </div>
