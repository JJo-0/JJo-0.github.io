...
- 파일명 규칙: `slide-01.png`, `slide-02.png`, ..., `slide-24.png`
- 한 슬라이드당 구성:
  - 슬라이드 이미지 1개
  - 핵심 메시지 2~4문장
  - 내 해석/비판 2~3문장
...
### Slide 22. (시각 자료 중심 슬라이드)
![Slide 22](/assets/slides/drl-robot-251110/slide-22.png)

텍스트가 거의 없는 시각 자료 중심 장으로 보이며, 발표자 구두 설명 비중이 큰 페이지다.  
실제 발표 화면을 확인해, 해당 그림/도표가 강조하는 핵심 문장을 2~3줄로 보완한다.

### Slide 23. (시각 자료 중심 슬라이드)
![Slide 23](/assets/slides/drl-robot-251110/slide-23.png)

슬라이드 22와 유사하게 텍스트 정보가 제한적이다.  
업로드 후 그림의 맥락(사례, 결과, 메시지)을 기준으로 설명을 추가 작성하는 것이 좋다.

### Slide 24. 마무리/연락처
![Slide 24](/assets/slides/drl-robot-251110/slide-24.png)

발표 전체를 다시 요약하고, 저자 및 연락처를 제시하는 마무리 장이다.  
리뷰 본문에서는 이 장 다음에 "내가 본 핵심 메시지 3가지"를 적어 결론을 명확히 하면 좋다.
