        ...
        <div class="bg-white rounded-2xl shadow-lg border border-gray-100 p-8">
            ...
            <div class="mb-8">
                ...
                <div class="space-y-6">
                    ...
                    <div class="bg-yellow-50 rounded-xl p-6 border border-yellow-200">
                        ...
                        <p class="text-yellow-800 text-sm leading-relaxed mb-3">
            ...
            <div class="mb-6">
                ...
                <div class="bg-gradient-to-r from-red-50 to-orange-50 rounded-lg p-6 mb-4 border border-red-200">
                    <h4 class="font-medium text-red-900 mb-2">위험: 대형 어류</h4>
                ...
                <div class="bg-gradient-to-r from-orange-50 to-amber-50 rounded-xl p-8 border border-orange-200">
                    ...
                    <div class="space-y-6">
                        ...
                        <div class="bg-white rounded-lg p-6">
                            <h4 class="text-lg font-semibold text-orange-900 mb-3">순도: IFOS 인증으로 확인하는 안전성</h4>
                        ...
                        <!-- 신선도 -->
                        <div class="bg-white rounded-lg p-6">
                            <h4 class="text-lg font-semibold text-orange-900 mb-3">신선도: TOTOX 값과 비린내 최소화 전략</h4>
                            <p class="text-orange-800 text-sm leading-relaxed mb-4">
