...
POST_TAXONOMY.update({
    ...
    '2026-09-21-single-fiber-hyperspectral-imaging-news.mdx': Taxonomy('finance-industry', 'hyperspectral-imaging', 'paper-review', ('frontier-candidate', 'hyperspectral-imaging', 'nanophotonics')),
    '2026-09-21-erbium-1540nm-led-news.mdx': Taxonomy('finance-industry', 'telecom-optoelectronics', 'paper-review', ('frontier-candidate', 'optoelectronics', 'telecom-photonics')),
})
