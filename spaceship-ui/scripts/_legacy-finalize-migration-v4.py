...
# 3. Reproduce restoreLegacyHtml at source level, iterating to a fixed point.
html_posts = [
...
# 4a. Resolve the only two audited Korean delimiter-boundary cases explicitly.
replace_exact(
    posts / 'ai-consciousness-deep-research-1.md',
...
replace_exact(
    posts / 'ai-consciousness-deep-research-2.md',
...
# 4b. Replace only exact literal-strong payloads found by the no-shim audit.
strong_posts = [
