...
if (source.includes('## 시리즈 구성') && source.includes(newTitle)) {
...
source = source.replace(/^updatedDate:\s*[^\n]+$/m, 'updatedDate: 2026-08-18');
...
source = source.replace(seriesPattern, replacement);
