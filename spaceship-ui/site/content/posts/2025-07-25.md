...
description: '인간 시각 시스템 정보 처리 메커니즘'
pubDate: 2025-07-25
tags: ['artificial-intelligence', '시각신경과학', '신경과학', 'fmri', '뉴럴디코딩', '시각피질', 'areas', 'neuroscience']
lang: 'ko'
---
...
## 핵심 요약
- 시각은 망막 입력을 그대로 복사하는 과정이 아니라, 뇌가 단계적으로 해석하고 재구성하는 정보 처리 과정입니다.
- 본문은 망막, LGN, V1, 고차 시각피질, 뉴럴 디코딩으로 이어지는 흐름을 구조적으로 설명합니다.
- 인터랙티브 탐험 경로를 통해 각 단계의 기능을 시각적으로 확인할 수 있습니다.

## 읽는 순서
1. 간상/원추세포 비교로 입력 단계 이해
2. 시각 경로 단계별 처리 원리 확인
3. 후반부 뉴럴 디코딩과 최신 연구 포인트 정리
...
document.addEventListener('astro:page-load', () => {
    ...
    function initV1Simulator() {
        ...
        slider.oninput = drawFilteredImage;
        drawFilteredImage();
    }
