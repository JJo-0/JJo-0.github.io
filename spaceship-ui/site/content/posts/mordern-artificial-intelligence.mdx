...
<!-- formula: MAI2-003 -->
<Math display tex={"A\\mathbf{x}=\\mathbf{b},\\qquad\nA=\\begin{bmatrix}A_{1,1}&A_{1,2}\\\\A_{2,1}&A_{2,2}\\end{bmatrix},\\qquad\n\\mathbf{b}=\\begin{bmatrix}b_1\\\\b_2\\end{bmatrix}."} />
### 2. 기본 표기

열벡터와 행렬의 차원을 항상 먼저 본다.

<!-- formula: MAI2-004 -->
<Math display tex={"\\mathbf{x}\\in\\mathbb{R}^{M},\\qquad \\mathbf{x}^{T}\\ \\text{is a row vector}."} />
<!-- formula: MAI2-005 -->
<Math display tex={"A\\in\\mathbb{R}^{M\\times N}."} />
<!-- formula: MAI2-006 -->
<Math display tex={"\\mathbf{x}=\n\\begin{bmatrix}\nx_1\\\\x_2\\\\\\vdots\\\\x_M\n\\end{bmatrix}."} />
<!-- formula: MAI2-007 -->
<Math display tex={"A=\n\\begin{bmatrix}\nA_{1,1}&A_{1,2}&\\cdots&A_{1,N}\\\\\nA_{2,1}&A_{2,2}&\\cdots&A_{2,N}\\\\\n\\vdots&\\vdots&\\ddots&\\vdots\\\\\nA_{M,1}&A_{M,2}&\\cdots&A_{M,N}\n\\end{bmatrix}."} />
열 단위 표기와 행 단위 표기도 자주 사용한다.

<!-- formula: MAI2-008 -->
<Math display tex={"A=\\begin{bmatrix}\\mathbf{a}_1&\\mathbf{a}_2&\\cdots&\\mathbf{a}_N\\end{bmatrix}."} />
<!-- formula: MAI2-009 -->
<Math display tex={"A=\\begin{bmatrix}\n\\mathbf{a}_1^T\\\\\n\\mathbf{a}_2^T\\\\\n\\vdots\\\\\n\\mathbf{a}_M^T\n\\end{bmatrix}."} />
### 3. 영상의 벡터화

다차원 영상을 하나의 긴 벡터로 펴면, convolution 같은 연산도 행렬-벡터 곱으로 표현할 수 있다.

<!-- formula: MAI2-010 -->
<Math display tex={"\\begin{bmatrix}y_1&\\cdots&y_N\\end{bmatrix}\n\\longrightarrow\n\\begin{bmatrix}y_1\\\\\\vdots\\\\y_N\\end{bmatrix}."} />
<!-- formula: MAI2-011 -->
<Math display tex={"y[m,n]=(a*x)[m,n]."} />
<!-- formula: MAI2-012 -->
<Math display tex={"\\mathbf{y}=A\\mathbf{x}."} />
### 4. 벡터-벡터 곱
...
<!-- formula: MAI2-013 -->
<Math display tex={"\\mathbf{x}^T\\mathbf{y}\n=\n\\begin{bmatrix}x_1&x_2&\\cdots&x_N\\end{bmatrix}\n\\begin{bmatrix}y_1\\\\y_2\\\\\\vdots\\\\y_N\\end{bmatrix}\n=\n\\sum_{i=1}^{N}x_i y_i\\in\\mathbb{R}."} />
<!-- formula: MAI2-014 -->
<Math display tex={"\\mathbf{x}^T\\mathbf{y}=\\mathbf{y}^T\\mathbf{x}."} />
#### 4.2 외적

외적은 두 벡터로부터 행렬을 만든다.

<!-- formula: MAI2-015 -->
<Math display tex={"\\mathbf{x}\\mathbf{y}^T\n=\n\\begin{bmatrix}\nx_1y_1&x_1y_2&\\cdots&x_1y_N\\\\\nx_2y_1&x_2y_2&\\cdots&x_2y_N\\\\\n\\vdots&\\vdots&\\ddots&\\vdots\\\\\nx_My_1&x_My_2&\\cdots&x_My_N\n\\end{bmatrix}\n\\in\\mathbb{R}^{M\\times N}."} />
### 5. 행렬-벡터 곱을 두 가지로 보기
...
<!-- formula: MAI2-017 -->
<Math display tex={"y_i=\\mathbf{a}_i^T\\mathbf{x}."} />
...
<!-- formula: MAI2-019 -->
<Math display tex={"\\mathbf{y}^T=\\mathbf{x}^T A\n=\n\\begin{bmatrix}\n\\mathbf{x}^T\\mathbf{a}_1&\n\\mathbf{x}^T\\mathbf{a}_2&\n\\cdots&\n\\mathbf{x}^T\\mathbf{a}_N\n\\end{bmatrix}."} />
<!-- formula: MAI2-020 -->
<Math display tex={"\\mathbf{y}^T=\\mathbf{x}^T A\n=\nx_1\\mathbf{a}_1^T+x_2\\mathbf{a}_2^T+\\cdots+x_M\\mathbf{a}_M^T."} />
### 6. 행렬-행렬 곱

<!-- formula: MAI2-021 -->
<Math display tex={"A\\in\\mathbb{R}^{M\\times N},\\quad\nB\\in\\mathbb{R}^{N\\times P},\\quad\nC=AB\\in\\mathbb{R}^{M\\times P}."} />
<!-- formula: MAI2-022 -->
<Math display tex={"C_{i,j}=\\sum_{k=1}^{N}A_{i,k}B_{k,j}."} />
행과 열의 내적을 한 번에 모으면 다음과 같다.

<!-- formula: MAI2-023 -->
<Math display tex={"C=AB=\n\\begin{bmatrix}\n\\mathbf{a}_1^T\\mathbf{b}_1&\\mathbf{a}_1^T\\mathbf{b}_2&\\cdots&\\mathbf{a}_1^T\\mathbf{b}_P\\\\\n\\mathbf{a}_2^T\\mathbf{b}_1&\\mathbf{a}_2^T\\mathbf{b}_2&\\cdots&\\mathbf{a}_2^T\\mathbf{b}_P\\\\\n\\vdots&\\vdots&\\ddots&\\vdots\\\\\n\\mathbf{a}_M^T\\mathbf{b}_1&\\mathbf{a}_M^T\\mathbf{b}_2&\\cdots&\\mathbf{a}_M^T\\mathbf{b}_P\n\\end{bmatrix}."} />
열-행 관점에서는 외적의 합이다.

<!-- formula: MAI2-024 -->
<Math display tex={"C=AB=\\sum_{i=1}^{N}\\mathbf{a}_i\\mathbf{b}_i^T."} />
B를 열벡터로 보면 C의 각 열은 A와 B의 한 열의 행렬-벡터 곱이다.

<!-- formula: MAI2-025 -->
<Math display tex={"C=A\\begin{bmatrix}\\mathbf{b}_1&\\mathbf{b}_2&\\cdots&\\mathbf{b}_P\\end{bmatrix}\n=\n\\begin{bmatrix}A\\mathbf{b}_1&A\\mathbf{b}_2&\\cdots&A\\mathbf{b}_P\\end{bmatrix}."} />
<!-- formula: MAI2-026 -->
<Math display tex={"\\mathbf{c}_i=A\\mathbf{b}_i."} />
A를 행벡터로 보면 C의 각 행은 다음처럼 얻는다.

<!-- formula: MAI2-027 -->
<Math display tex={"C=\n\\begin{bmatrix}\n\\mathbf{a}_1^TB\\\\\n\\mathbf{a}_2^TB\\\\\n\\vdots\\\\\n\\mathbf{a}_M^TB\n\\end{bmatrix}."} />
<!-- formula: MAI2-028 -->
<Math display tex={"\\mathbf{c}_i^T=\\mathbf{a}_i^TB."} />
#### 6.1 곱셈의 기본 성질

<!-- formula: MAI2-029 -->
<Math display tex={"(AB)C=A(BC)."} />
<!-- formula: MAI2-030 -->
<Math display tex={"A(B+C)=AB+AC."} />
<!-- formula: MAI2-031 -->
<Math display tex={"AB\\neq BA\\quad\\text{in general}."} />
### 7. 항등행렬과 대각행렬

<!-- formula: MAI2-032 -->
<Math display tex={"I_{i,j}=\n\\begin{cases}\n1,&i=j,\\\\\n0,&i\\neq j.\n\\end{cases}"} />
<!-- formula: MAI2-033 -->
<Math display tex={"AI=A=IA."} />
<!-- formula: MAI2-034 -->
<Math display tex={"D=\\operatorname{diag}(d_1,\\ldots,d_N),\\qquad\nD_{i,j}=\n\\begin{cases}\nd_i,&i=j,\\\\\n0,&i\\neq j.\n\\end{cases}"} />
<!-- formula: MAI2-035 -->
<Math display tex={"I=\\operatorname{diag}(1,\\ldots,1)."} />
### 8. 전치

<!-- formula: MAI2-036 -->
<Math display tex={"(A^T)_{i,j}=A_{j,i}."} />
<!-- formula: MAI2-037 -->
<Math display tex={"(A^T)^T=A."} />
<!-- formula: MAI2-038 -->
<Math display tex={"(AB)^T=B^TA^T."} />
<!-- formula: MAI2-039 -->
<Math display tex={"(A+B)^T=A^T+B^T."} />
### 9. 2026년 구현 관점
...
<!-- formula: MAI3-004 -->
<Math display tex={"\\operatorname{tr}(A)=\\sum_{i=1}^{N}A_{i,i}."} />
<!-- formula: MAI3-005 -->
<Math display tex={"\\operatorname{tr}(A)=\\operatorname{tr}(A^T)."} />
<!-- formula: MAI3-006 -->
<Math display tex={"\\operatorname{tr}(A+B)=\\operatorname{tr}(A)+\\operatorname{tr}(B)."} />
<!-- formula: MAI3-007 -->
<Math display tex={"\\operatorname{tr}(tA)=t\\,\\operatorname{tr}(A)."} />
<!-- formula: MAI3-008 -->
<Math display tex={"\\operatorname{tr}(AB)=\\operatorname{tr}(BA)."} />
<!-- formula: MAI3-009 -->
<Math display tex={"\\operatorname{tr}(ABC)=\\operatorname{tr}(BCA)=\\operatorname{tr}(CAB)."} />
### 3. 노름

#### 3.1 유클리드 노름

<!-- formula: MAI3-010 -->
<Math display tex={"\\|\\mathbf{x}\\|_2=\\sqrt{\\sum_{i=1}^{N}x_i^2}."} />
<!-- formula: MAI3-011 -->
<Math display tex={"\\|\\mathbf{x}\\|_2^2=\\mathbf{x}^T\\mathbf{x}."} />
노름은 길이의 일반화이며 네 성질을 만족한다.

<!-- formula: MAI3-012 -->
<Math display tex={"f(\\mathbf{x})\\ge 0."} />
<!-- formula: MAI3-013 -->
<Math display tex={"f(\\mathbf{x})=0\\iff \\mathbf{x}=0."} />
<!-- formula: MAI3-014 -->
<Math display tex={"f(t\\mathbf{x})=|t|f(\\mathbf{x})."} />
<!-- formula: MAI3-015 -->
<Math display tex={"f(\\mathbf{x}+\\mathbf{y})\\le f(\\mathbf{x})+f(\\mathbf{y})."} />
다른 대표 노름도 함께 둔다.

<!-- formula: MAI3-016 -->
<Math display tex={"\\|\\mathbf{x}\\|_1=\\sum_{i=1}^{N}|x_i|."} />
<!-- formula: MAI3-017 -->
<Math display tex={"\\|\\mathbf{x}\\|_\\infty=\\max_i |x_i|."} />
<!-- formula: MAI3-018 -->
<Math display tex={"\\|\\mathbf{x}\\|_p=\n\\left(\\sum_{i=1}^{N}|x_i|^p\\right)^{1/p},\\qquad p\\ge1."} />
행렬에 대해서는 Frobenius 노름이 자주 등장한다.

<!-- formula: MAI3-019 -->
<Math display tex={"\\|A\\|_F=\n\\sqrt{\\sum_{i=1}^{M}\\sum_{j=1}^{N}A_{i,j}^2}\n=\n\\sqrt{\\operatorname{tr}(A^TA)}."} />
### 4. 선형독립과 랭크

한 벡터가 나머지 벡터의 선형결합으로 표현되면 그 집합은 선형종속이다.

<!-- formula: MAI3-020 -->
<Math display tex={"\\mathbf{x}_N=\\sum_{i=1}^{N-1}\\alpha_i\\mathbf{x}_i."} />
강의자료의 예시는 다음 세 벡터다.

<!-- formula: MAI3-021 -->
<Math display tex={"\\mathbf{x}_1=\n\\begin{bmatrix}1\\\\2\\\\3\\end{bmatrix},\\quad\n\\mathbf{x}_2=\n\\begin{bmatrix}4\\\\1\\\\5\\end{bmatrix},\\quad\n\\mathbf{x}_3=\n\\begin{bmatrix}2\\\\-3\\\\-1\\end{bmatrix}."} />
<!-- formula: MAI3-022 -->
<Math display tex={"\\mathbf{x}_3=-2\\mathbf{x}_1+\\mathbf{x}_2."} />
랭크의 기본 성질은 다음과 같다.

<!-- formula: MAI3-023 -->
<Math display tex={"\\operatorname{rank}(A)\\le\\min(M,N),\\qquad A\\in\\mathbb{R}^{M\\times N}."} />
<!-- formula: MAI3-024 -->
<Math display tex={"\\operatorname{rank}(A)=\\operatorname{rank}(A^T)."} />
<!-- formula: MAI3-025 -->
<Math display tex={"\\operatorname{rank}(AB)\\le\\min(\\operatorname{rank}(A),\\operatorname{rank}(B))."} />
<!-- formula: MAI3-026 -->
<Math display tex={"\\operatorname{rank}(A+B)\\le\\operatorname{rank}(A)+\\operatorname{rank}(B)."} />
### 5. 역행렬

<!-- formula: MAI3-027 -->
<Math display tex={"A^{-1}A=I=AA^{-1}."} />
정사각행렬이더라도 singular이면 역행렬이 없다. 비특이 행렬에 대한 성질은 다음과 같다.

<!-- formula: MAI3-028 -->
<Math display tex={"(A^{-1})^{-1}=A."} />
<!-- formula: MAI3-029 -->
<Math display tex={"(AB)^{-1}=B^{-1}A^{-1}."} />
<!-- formula: MAI3-030 -->
<Math display tex={"(A^{-1})^T=(A^T)^{-1}\\equiv A^{-T}."} />
### 6. 직교성과 직교행렬

<!-- formula: MAI3-031 -->
<Math display tex={"\\mathbf{x}^T\\mathbf{y}=0."} />
<!-- formula: MAI3-032 -->
<Math display tex={"\\|\\mathbf{x}\\|_2=1."} />
정사각 직교행렬 U는 열들이 orthonormal이고 다음을 만족한다.

<!-- formula: MAI3-033 -->
<Math display tex={"U^TU=I=UU^T."} />
직사각행렬의 열만 orthonormal일 때는 한쪽만 항등행렬이 된다.

<!-- formula: MAI3-034 -->
<Math display tex={"U^TU=I,\\qquad UU^T\\neq I\\quad (U\\in\\mathbb{R}^{M\\times N},\\,N<M)."} />
직교변환은 유클리드 길이를 보존한다.

<!-- formula: MAI3-035 -->
<Math display tex={"\\|U\\mathbf{x}\\|_2=\\|\\mathbf{x}\\|_2."} />
### 7. 행렬식
...
<Math display tex={"A=\n\\begin{bmatrix}\n1&3\\\\\n3&2\n\\end{bmatrix}."} />
<!-- formula: MAI3-038 -->
<Math display tex={"\\mathbf{a}_1=\n\\begin{bmatrix}1\\\\3\\end{bmatrix},\\qquad\n\\mathbf{a}_2=\n\\begin{bmatrix}3\\\\2\\end{bmatrix}."} />
<!-- formula: MAI3-039 -->
<Math display tex={"\\det(A)=|A|=-7,\\qquad |\\det(A)|=7."} />
행렬식의 핵심 성질을 모두 적는다.

<!-- formula: MAI3-040 -->
<Math display tex={"|I|=1."} />
<!-- formula: MAI3-041 -->
<Math display tex={"\\det\n\\begin{bmatrix}\nt\\mathbf{a}_1^T\\\\\n\\mathbf{a}_2^T\\\\\n\\vdots\\\\\n\\mathbf{a}_N^T\n\\end{bmatrix}\n=t|A|."} />
<!-- formula: MAI3-042 -->
<Math display tex={"\\det\n\\begin{bmatrix}\n\\mathbf{a}_2^T\\\\\n\\mathbf{a}_1^T\\\\\n\\vdots\\\\\n\\mathbf{a}_N^T\n\\end{bmatrix}\n=-|A|."} />
<!-- formula: MAI3-043 -->
<Math display tex={"|A|=|A^T|."} />
<!-- formula: MAI3-044 -->
<Math display tex={"|AB|=|A||B|."} />
<!-- formula: MAI3-045 -->
<Math display tex={"|A|=0\\iff A\\ \\text{is singular}."} />
<!-- formula: MAI3-046 -->
<Math display tex={"|A^{-1}|=\\frac{1}{|A|}."} />
### 8. 2026년 수치계산 관점
...
<!-- formula: MAI4-003 -->
<Math display tex={"A\\succ0\n\\iff\n\\mathbf{x}^TA\\mathbf{x}>0\n\\quad\\text{for all }\\mathbf{x}\\neq0."} />
<!-- formula: MAI4-004 -->
<Math display tex={"A\\succeq0\n\\iff\n\\mathbf{x}^TA\\mathbf{x}\\ge0\n\\quad\\text{for all }\\mathbf{x}."} />
<!-- formula: MAI4-005 -->
<Math display tex={"A\\prec0\n\\iff\n\\mathbf{x}^TA\\mathbf{x}<0\n\\quad\\text{for all }\\mathbf{x}\\neq0."} />
<!-- formula: MAI4-006 -->
<Math display tex={"A\\preceq0\n\\iff\n\\mathbf{x}^TA\\mathbf{x}\\le0\n\\quad\\text{for all }\\mathbf{x}."} />
indefinite는 어떤 방향에서는 양수, 다른 방향에서는 음수가 되는 경우다.

<!-- formula: MAI4-007 -->
<Math display tex={"\\exists\\mathbf{x}_1,\\mathbf{x}_2:\n\\quad\n\\mathbf{x}_1^TA\\mathbf{x}_1>0,\\qquad\n\\mathbf{x}_2^TA\\mathbf{x}_2<0."} />
### 3. 고유값과 고유벡터

<!-- formula: MAI4-008 -->
<Math display tex={"A\\mathbf{x}=\\lambda\\mathbf{x},\\qquad \\mathbf{x}\\neq0."} />
고유값은 trace, determinant, rank와 직접 연결된다.

<!-- formula: MAI4-009 -->
<Math display tex={"\\operatorname{tr}(A)=\\sum_{i=1}^{N}\\lambda_i."} />
<!-- formula: MAI4-010 -->
<Math display tex={"|A|=\\prod_{i=1}^{N}\\lambda_i."} />
<!-- formula: MAI4-011 -->
<Math display tex={"\\operatorname{rank}(A)=\\#\\{i:\\lambda_i\\neq0\\}."} />
<!-- formula: MAI4-012 -->
<Math display tex={"A^{-1}\\mathbf{x}_i=\\frac{1}{\\lambda_i}\\mathbf{x}_i."} />
<!-- formula: MAI4-013 -->
<Math display tex={"D=\\operatorname{diag}(d_1,\\ldots,d_N)\n\\quad\\Longrightarrow\\quad\n\\lambda_i=d_i."} />
모든 고유벡터 방정식을 한 번에 쓰면 다음과 같다.

<!-- formula: MAI4-014 -->
<Math display tex={"AX=X\\Lambda."} />
<!-- formula: MAI4-015 -->
<Math display tex={"X=\n\\begin{bmatrix}\\mathbf{x}_1&\\mathbf{x}_2&\\cdots&\\mathbf{x}_N\\end{bmatrix},\n\\qquad\n\\Lambda=\\operatorname{diag}(\\lambda_1,\\ldots,\\lambda_N)."} />
X가 invertible이면 A는 diagonalizable이다.

<!-- formula: MAI4-016 -->
<Math display tex={"A=X\\Lambda X^{-1}."} />
### 4. 대칭행렬의 고유분해

대칭행렬의 고유값은 실수이고 고유벡터를 orthonormal하게 잡을 수 있다.

<!-- formula: MAI4-017 -->
<Math display tex={"A=U\\Lambda U^T."} />
이 구조 덕분에 definiteness는 고유값의 부호로 판정할 수 있다.

<!-- formula: MAI4-018 -->
<Math display tex={"\\mathbf{x}^TA\\mathbf{x}\n=\n\\mathbf{x}^TU\\Lambda U^T\\mathbf{x}\n=\n\\mathbf{y}^T\\Lambda\\mathbf{y}\n=\n\\sum_{i=1}^{N}\\lambda_i y_i^2."} />
<!-- formula: MAI4-019 -->
<Math display tex={"\\mathbf{y}=U^T\\mathbf{x}."} />
### 5. 행렬에 대한 기울기
...
<!-- formula: MAI4-025 -->
<Math display tex={"\\frac{\\partial^2f(\\mathbf{x})}{\\partial x_i\\partial x_j}\n=\n\\frac{\\partial^2f(\\mathbf{x})}{\\partial x_j\\partial x_i}."} />
### 7. 선형·이차함수의 미분 공식
...
<!-- formula: MAI5-001 -->
<Math display tex={"z_i^{(\\ell)}\n=\n\\sum_{j=1}^{n_{\\ell-1}}\nw_{i,j}^{(\\ell)}a_j^{(\\ell-1)}\n+b_i^{(\\ell)}."} />
<!-- formula: MAI5-002 -->
<Math display tex={"a_i^{(\\ell)}=h\\!\\left(z_i^{(\\ell)}\\right)."} />
### 2. 2차원 직선에서 N차원 초평면으로

2차원 직선은 다음처럼 쓸 수 있다.

<!-- formula: MAI5-003 -->
<Math display tex={"y=ax+c."} />
일반적인 선형 경계 형태로 바꾸면 다음과 같다.

<!-- formula: MAI5-004 -->
<Math display tex={"w_1x_1+w_2x_2+b=0."} />
N차원에서는 초평면이 된다.

<!-- formula: MAI5-005 -->
<Math display tex={"\\sum_{n=1}^{N}w_nx_n+b=0."} />
<!-- formula: MAI5-006 -->
<Math display tex={"\\mathbf{w}^T\\mathbf{x}+b=0."} />
### 3. 퍼셉트론의 판별 함수

<!-- formula: MAI5-007 -->
<Math display tex={"d(\\mathbf{x})=\\operatorname{sign}(g(\\mathbf{x})),\n\\qquad\ng(\\mathbf{x})=\\mathbf{w}^T\\mathbf{x}+b."} />
<!-- formula: MAI5-008 -->
<Math display tex={"\\operatorname{sign}(a)=\n\\begin{cases}\n-1,&a<0,\\\\\n0,&a=0,\\\\\n1,&a>0.\n\\end{cases}"} />
#### 3.1 결정경계의 기하학
...
<!-- formula: MAI5-009 -->
<Math display tex={"\\operatorname{dist}(0,\\text{boundary})=\\frac{b}{\\|\\mathbf{w}\\|_2}."} />
부호까지 포함한 점 x의 경계면 상대 위치는 다음 값으로 읽을 수 있다.

<!-- formula: MAI5-010 -->
<Math display tex={"\\operatorname{signed\\ distance}(\\mathbf{x})\n=\n\\frac{g(\\mathbf{x})}{\\|\\mathbf{w}\\|_2}."} />
<!-- formula: MAI5-011 -->
...
<!-- formula: MAI5-012 -->
<Math display tex={"\\mathcal{D}=\n\\{(\\mathbf{x}_1,y_1),\\ldots,(\\mathbf{x}_M,y_M)\\}."} />
<!-- formula: MAI5-013 -->
<Math display tex={"\\big(y_m=1\\land g(\\mathbf{x}_m)>0\\big)\n\\ \\lor\\\n\\big(y_m=-1\\land g(\\mathbf{x}_m)<0\\big),\n\\qquad\\forall m."} />
한 줄로는 다음과 같다.

<!-- formula: MAI5-014 -->
<Math display tex={"y_m\\,g(\\mathbf{x}_m)>0,\\qquad\\forall m."} />
### 5. 비선형 판별기와 컨볼루션

DNN의 핵심 구성 중 하나인 convolution을 연속형부터 적는다.

<!-- formula: MAI5-015 -->
<Math display tex={"(f*g)(t)\n=\n\\int_{-\\infty}^{\\infty}\nf(\\tau)g(t-\\tau)\\,d\\tau."} />
이산형은 다음 두 표현이 동치다.

<!-- formula: MAI5-016 -->
<Math display tex={"(f*g)[n]\n=\n\\sum_{m=-\\infty}^{\\infty}\nf[m]\\,g[n-m]."} />
<!-- formula: MAI5-017 -->
<Math display tex={"(f*g)[n]\n=\n\\sum_{m=-\\infty}^{\\infty}\nf[n-m]\\,g[m]."} />
### 6. DNN에서 자주 쓰는 모듈
...
<!-- formula: MAI6-001 -->
<Math display tex={"F_X(x)=P\\{X\\le x\\},\\qquad \\forall x\\in\\mathbb{R}."} />
<!-- formula: MAI6-002 -->
<Math display tex={"\\lim_{t\\to\\infty}F_X(t)=1,\\qquad\n\\lim_{t\\to-\\infty}F_X(t)=0."} />
<!-- formula: MAI6-003 -->
<Math display tex={"p_X(x)=\\frac{dF_X(x)}{dx}."} />
### 2. 이산·연속 분포
...
<!-- formula: MAI6-004 -->
<Math display tex={"P\\{X=k\\}=e^{-\\lambda}\\frac{\\lambda^k}{k!},\n\\qquad k=0,1,2,\\ldots,\\quad \\lambda>0."} />
평균 μ, 분산 σ²의 단변량 Gaussian PDF는 다음과 같다.

<!-- formula: MAI6-005 -->
<Math display tex={"p_X(x)\n=\n\\frac{1}{\\sqrt{2\\pi\\sigma^2}}\n\\exp\\!\\left(\n-\\frac12\\frac{(x-\\mu)^2}{\\sigma^2}\n\\right)."} />
### 3. 독립성

<!-- formula: MAI6-006 -->
<Math display tex={"p_{X,Y}(x,y)=p_X(x)p_Y(y)."} />
### 4. 평균·기대값·분산·상관

<!-- formula: MAI6-007 -->
<Math display tex={"\\mu_X=E[X]=\\int x\\,p_X(x)\\,dx."} />
<!-- formula: MAI6-008 -->
<Math display tex={"E[g(X)]=\\int g(x)p_X(x)\\,dx."} />
<!-- formula: MAI6-009 -->
<Math display tex={"\\operatorname{Var}(X)\n=\nE\\!\\left[|X-E[X]|^2\\right]\n=\nE[|X|^2]-|E[X]|^2."} />
<!-- formula: MAI6-010 -->
<Math display tex={"E[XY^*]\n=\n\\iint xy^*p_{X,Y}(x,y)\\,dx\\,dy."} />
...
<!-- formula: MAI6-012 -->
<Math display tex={"\\operatorname{Cov}(X,Y)\n=\nE[(X-E[X])(Y-E[Y])^*]\n=\nE[XY^*]-E[X]E[Y^*]."} />
ensemble mean과 유한 샘플의 sample mean은 구분해야 한다.

<!-- formula: MAI6-013 -->
<Math display tex={"\\bar{x}=\\frac1N\\sum_{n=1}^{N}x_n."} />
공분산 성질을 모두 적는다.
...
<!-- formula: MAI6-016 -->
<Math display tex={"\\operatorname{Cov}(X,X)=\\operatorname{Var}(X)."} />
<!-- formula: MAI6-017 -->
<Math display tex={"\\operatorname{Cov}(aX+b,cY+d)\n=\nac^*\\operatorname{Cov}(X,Y)."} />
<!-- formula: MAI6-018 -->
<Math display tex={"|\\operatorname{Cov}(X,Y)|\\le\\sigma_X\\sigma_Y,\n\\qquad\n\\sigma_X^2=\\operatorname{Var}(X),\\ \n\\sigma_Y^2=\\operatorname{Var}(Y)."} />
<!-- formula: MAI6-019 -->
<Math display tex={"|E[XY^*]|\n\\le\n\\sqrt{E[|X|^2]E[|Y|^2]}."} />
<!-- formula: MAI6-020 -->
<Math display tex={"X\\perp Y\n\\quad\\Longrightarrow\\quad\nE[XY]=\\mu_X\\mu_Y\n\\quad\\Longrightarrow\\quad\n\\operatorname{Cov}(X,Y)=0."} />
역은 일반적으로 성립하지 않는다. 다만 jointly Gaussian에서는 uncorrelated가 independence로 이어지는 특별한 성질이 있다.

<!-- formula: MAI6-021 -->
<Math display tex={"\\operatorname{Cov}\\!\\left(\\sum_n X_n,\\sum_mY_m\\right)\n=\n\\sum_i\\sum_j\\operatorname{Cov}(X_i,Y_j)."} />
...
<!-- formula: MAI6-023 -->
<Math display tex={"\\left(\\sum_{n=1}^{N}x_n^2\\right)\n\\left(\\sum_{n=1}^{N}y_n^2\\right)\n\\ge\n\\left(\\sum_{n=1}^{N}x_ny_n\\right)^2."} />
### 7. 조건부확률

<!-- formula: MAI6-024 -->
<Math display tex={"P(A\\mid B)."} />
<!-- formula: MAI6-025 -->
<Math display tex={"F_Y(y)=\\lim_{x\\to\\infty}F_{X,Y}(x,y)."} />
<!-- formula: MAI6-026 -->
<Math display tex={"F_{X,Y}(x,y)\n=\n\\int_{-\\infty}^{y}\nF_{X\\mid Y}(x\\mid t)\\,dF_Y(t)."} />
<!-- formula: MAI6-027 -->
<Math display tex={"F_{X\\mid Y}(x\\mid y)\n=\n\\frac{dF_{X,Y}(x,y)}{dy}\n\\left(\n\\frac{dF_{X,Y}(\\infty,y)}{dy}\n\\right)^{-1}."} />
밀도함수 형태로 바꾸면 더 익숙해진다.

<!-- formula: MAI6-028 -->
<Math display tex={"p_{X,Y}(x,y)\n=\n\\frac{d^2F_{X,Y}(x,y)}{dx\\,dy}."} />
<!-- formula: MAI6-029 -->
<Math display tex={"p_Y(y)=\\frac{dF(\\infty,y)}{dy}."} />
<!-- formula: MAI6-030 -->
<Math display tex={"p_{X\\mid Y}(x\\mid y)\n=\n\\frac{p_{X,Y}(x,y)}{p_Y(y)}."} />
독립이면 조건을 걸어도 X의 분포가 바뀌지 않는다.

<!-- formula: MAI6-031 -->
<Math display tex={"p_{X\\mid Y}(x\\mid y)=p_X(x),\n\\qquad\n\\forall x,y\\ \\text{with }p_Y(y)>0."} />
### 8. 조건부기대값

<!-- formula: MAI6-032 -->
<Math display tex={"E[X\\mid Y]\n=\n\\int_{-\\infty}^{\\infty}\nx\\,dF_{X\\mid Y}(x\\mid Y)."} />
<!-- formula: MAI6-033 -->
<Math display tex={"E[X\\mid Y]\n=\n\\int_{-\\infty}^{\\infty}\nx\\,p_{X\\mid Y}(x\\mid Y)\\,dx."} />
조건부기대값은 Y의 함수이므로 그 자체가 확률변수다.

<!-- formula: MAI6-034 -->
<Math display tex={"I_A(X)=\n\\begin{cases}\n1,&X\\in A,\\\\\n0,&\\text{otherwise}.\n\\end{cases}"} />
<!-- formula: MAI6-035 -->
<Math display tex={"P\\{X\\in A\\mid Y\\}=E[I_A(X)\\mid Y]."} />
#### 8.1 Filtration property

<!-- formula: MAI6-036 -->
<Math display tex={"E[E[X\\mid Y,Z]\\mid Y]=E[X\\mid Y]."} />
...
<!-- formula: MAI6-037 -->
<Math display tex={"E[X]=E[E[X\\mid Y]]."} />
#### 8.2 이미 알려진 양을 조건으로 둘 때

<!-- formula: MAI6-038 -->
<Math display tex={"E[f(X)Z\\mid X,Y]\n=\nf(X)E[Z\\mid X,Y]."} />
<!-- formula: MAI6-039 -->
<Math display tex={"E[X\\mid X,Y]=X."} />
<!-- formula: MAI6-040 -->
<Math display tex={"E[E[X\\mid Y,Z]\\mid Y]\n=\nE[X\\mid Y]\n=\nE[E[X\\mid Y]\\mid Y,Z]."} />
### 9. deterministic인가 random인가

강의의 체크 질문도 식으로 남긴다.

<!-- formula: MAI6-041 -->
<Math display tex={"Y=f(X)."} />
<!-- formula: MAI6-042 -->
<Math display tex={"\\mu=E[X]."} />
<!-- formula: MAI6-043 -->
<Math display tex={"\\widehat{X}=E[X\\mid Z]."} />
<!-- formula: MAI6-044 -->
<Math display tex={"\\widehat{X}=E[X\\mid Z=z_0]."} />
해석은 다음과 같다.
...
<!-- formula: MAI7-014 -->
<Math display tex={"\\|\\mathbf{x}\\|_A^2\n=\n\\mathbf{x}^HA\\mathbf{x}>0,\n\\qquad\n\\forall\\mathbf{x}\\in\\mathbb{C}^N,\\ \\mathbf{x}\\neq0."} />
### 4. 공분산의 직교대각화와 decorrelation

<!-- formula: MAI7-015 -->
<Math display tex={"C=E\\Lambda E^H."} />
<!-- formula: MAI7-016 -->
<Math display tex={"\\widetilde{\\mathbf{X}}=E^H\\mathbf{X}."} />
<!-- formula: MAI7-017 -->
<Math display tex={"E[\\widetilde{\\mathbf{X}}\\widetilde{\\mathbf{X}}^H]=\\Lambda."} />
<!-- formula: MAI7-018 -->
<Math display tex={"E[\\widetilde{X}_i\\widetilde{X}_j]=0,\n\\qquad i\\neq j."} />
...
<Math display tex={"R_{-\\mathbf{s},(0,0)}\n=\nR_{(0,0)-\\mathbf{s},(0,0)}\n=\nR_{(0,0),\\mathbf{s}}\n=\nR_{\\mathbf{s},(0,0)}^*."} />
<!-- formula: MAI7-042 -->
<Math display tex={"|R_{\\mathbf{s}}|\\le R_{\\mathbf{s},(0,0)}."} />
### 9. 2D 전력 스펙트럼 밀도

WSS 과정 자체의 DSFT를 직접 정의하는 것이 아니라 **autocorrelation의 DSFT**를 power spectrum으로 사용한다.

<!-- formula: MAI7-043 -->
<Math display tex={"S_X(e^{i\\mu},e^{i\\nu})\n=\n\\sum_{m=-\\infty}^{\\infty}\n\\sum_{n=-\\infty}^{\\infty}\nR_{(m,n),(0,0)}\ne^{-i(m\\mu+n\\nu)}."} />
이 관계가 Wiener–Khinchin 정리의 핵심이다.

#### 9.1 평균 0인 WSS white process

<!-- formula: MAI7-044 -->
<Math display tex={"R_{(m,n),(0,0)}\n=\nC_{(m,n),(0,0)}\n=\n\\sigma^2\\delta[m,n]."} />
<!-- formula: MAI7-045 -->
<Math display tex={"S_X(e^{i\\mu},e^{i\\nu})=\\sigma^2."} />
#### 9.2 평균이 0이 아닐 때

<!-- formula: MAI7-046 -->
<Math display tex={"C_{(m,n),(0,0)}=\\sigma^2\\delta[m,n]."} />
<!-- formula: MAI7-047 -->
<Math display tex={"R_{(m,n),(0,0)}\n=\n\\sigma^2\\delta[m,n]\n+\n|\\mu_{(0,0)}|^2."} />
<!-- formula: MAI7-048 -->
...
<!-- formula: MAI8-004 -->
<Math display tex={"\\|\\mathbf{x}\\|_2^2\n=\n\\sum_n |x_n|^2."} />
### 4. 기울기
...
<!-- formula: MAI8-013 -->
<Math display tex={"\\sum_{l=1}^{L}f_l(\\mathbf{x})."} />
### 8. 배치 크기 논쟁
