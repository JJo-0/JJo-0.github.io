---
title: '선형 대수'
description: '✅ Step 1: 이미지 기반 개념 정리 및 블로그 초안 구성 시작...'
pubDate: 2025-05-08
...
노름(norm)은 벡터 또는 행렬의 길이(length) 또는 <strong>크기(magnitude)</strong>를 측정하는 함수입니다.
...
벡터뿐 아니라 <strong>행렬(matrix)</strong>에도 노름을 정의할 수 있습니다. 가장 대표적인 예는 Frobenius 노름입니다.
